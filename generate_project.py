...
package_json_content = """{
  "name": "elekta-prodsec-onboarding",
  "private": true,
  "version": "1.0.0",
  "type": "module",
  "scripts": {
...
app_jsx_content = r"""import React, { useState, useEffect, useRef } from 'react';
...
const HERO_DATA = {
  ...
  stats: [
    ...
    { label: "AI/ML Security", value: 85, color: "bg-purple-400" },
    { label: "DevSecOps", value: 90, color: "bg-cyan-400" },
    { label: "Threat Analysis", value: 88, color: "bg-green-400" }
  ],
  traits: [
